...
from qube.src.api.kitten33controller import kitten33Controller
from qube.src.api.kitten33controller import kitten33ItemController
from qube.src.api.versioncontroller import kitten33ItemVersionController
...
api.add_resource(kitten33ItemVersionController, '/v1/kitten33/version')
api.add_resource(kitten33Controller, '/v1/kitten33')
api.add_resource(kitten33ItemController, '/v1/kitten33/<string:entity_id>')
