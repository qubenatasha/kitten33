...
HELLO_VERSION = "/v1/kitten33/version"
...
class Testkitten33VersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_kitten33_default_version(self, *args, **kwargs):
    ...
    def test_kitten33_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
